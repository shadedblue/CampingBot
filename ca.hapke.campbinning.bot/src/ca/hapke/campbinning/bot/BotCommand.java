...
// * @author Nathan Hapke
// */
//public enum OLDBotCommand implements CommandType {
//
...
//
//	private OLDBotCommand(String command, boolean forDb) {
...
//	 */
//	private OLDBotCommand(String command, boolean forDb, long id) {
